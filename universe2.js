;(function (window) {
    ...
    let texts = ['HEYY :)','HAPPY BIRTHDAY', 'HEHEHE', 'COBA LIHAT DEH', 'LIHAT LANGITNYA', 'CANTIK YAA', 'BANYAK KUNANG-KUNANG', 'ADA BINTANG JATUH JUGA', 'AKU MAUU','DI HARI INI', 'DI SINIII', 'KAMU MAKE A WISH', 'BERDOAAA YAA', 'SEBANYAK-BANYAKNYA', 'APAPUN YANG KAMU MAU','SEMUA HARAPAN KAMU', 'KEINGINAN KAMU', 'IMPIAN KAMUU', 'YANG TERBAIK BUAT KAMUU', 'SEKARANG', 'MEREM DULU', '😌😌😌', 'UDAAH??', 'AAAMIIINN', 'SEMOGA TERKABUL YAA', 'TERAKHIR NII', 'HAPPY', 'BIRTHDAY', 'OLEENN :)']
